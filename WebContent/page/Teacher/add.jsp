...
<html>
	...
	<body>
		<div class="add">
		<form id="addForm" action="http://localhost:8080/xuan_ke/teacher?method=add" method="post">
			<table class="tableadd">
				<tr>
					<td>姓名</td>
					<td style="color: red;" ><input type="text" name="tName"/></td>
				</tr>
				<tr>
					<td>工号</td>
					<td style="color: red;" ><input type="text" name="tNO"/></td>
				</tr>
				<tr>
					<td>密码</td>
					<td style="color: red;" >
					<input type="password" name="tPwd" value="123"/>
					</td>
				</tr>
				<tr>
					<td>初始密码为123</td>	
